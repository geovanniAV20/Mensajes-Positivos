...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Integer> indexMensaje = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView2 = findViewById(R.id.diaNoche);
        vista = findViewById(R.id.Vista);

        textView.setText("Bienvenido");
        textView2.setText("Día");
    ...
    public void siguiente(View view){
        ...
        indexMensaje.add(random);
        textView.setText(mensajes[random]);
    }

    public void atras(View view){
        if(indexMensaje.size() > 1) {
            int prevText = indexMensaje.get(indexMensaje.size() - 2);
            indexMensaje.remove(indexMensaje.get(indexMensaje.size() - 1));
            Log.d(TAG, "array = " + indexMensaje);
            Log.d(TAG, "prevText = " + prevText);
            textView.setText(mensajes[prevText]);
        }
    }

    public void background(View view){
        if(textView2.getText() == "Día")
        {
            textView2.setText("Noche");
            textView2.setTextColor(Color.argb(255, 255, 255, 255));
            vista.setBackgroundColor(Color.argb(255, 82, 86, 94));
        }
        else
        {
            textView2.setText("Día");
            textView2.setTextColor(Color.argb(255, 0, 0, 0));
            vista.setBackgroundColor(Color.argb(255, 255, 255, 255));
        }
    }
